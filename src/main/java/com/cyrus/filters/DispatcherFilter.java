 ...
 * @author Cyrus
 */
@WebFilter(filterName = "DispatcherFilter", urlPatterns = {"/*"}, dispatcherTypes = {DispatcherType.REQUEST, DispatcherType.FORWARD})
public class DispatcherFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            ...
            logger.error("Error DispatcherFilter at: " + t.getMessage());
        }
