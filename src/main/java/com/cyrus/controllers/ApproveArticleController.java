...
public class ApproveArticleController extends HttpServlet {
    ...
    private final static Logger logger = Logger.getLogger(ApproveArticleController.class);
    private static final ArticleDAO dao = ArticleDAO.getInstance();
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            logger.error("Error ApproveArticleController at: " + e.getMessage());
        } finally {
