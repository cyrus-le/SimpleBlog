...
<html>
    ...
    <body>
        ...
        <div id="container">
            ...
            <g id="Calque_1">
            <text id="XMLID_3_" transform="matrix(1.2187 0 0 1 13 75.6393)" class="st0 st1">Error</text>
            <text id="XMLID_4_" transform="matrix(1.2187 0 0 1 133.0003 73.6393)" class="st0 st1">Page</text>
            </g>
            <g id="Calque_2">
            <g>
            ...
            <br>
            <a href="${BACK}" style="color: red; text-decoration: none">Click here to go back</a> 
